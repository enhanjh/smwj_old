...
namespace SMWJ
{
    ...
    public class KOACode
    {
        ...
        public struct ReqGb
        {
            ...
            public ReqGb(string strCode, string strName)
            {
                this.Code = strCode;
                this.Name = strName;
            }
        ...
        public readonly static ReqGb[] reqGb = new ReqGb[12];
        ...
        static KOACode()
        {
            ...
            // 요청구분 설정
            reqGb[0] = new ReqGb("90", "타이머시작");
            reqGb[1] = new ReqGb("00", "직전영업일상한가풀조회");
            reqGb[2] = new ReqGb("01", "쌍매수풀조회");
            reqGb[3] = new ReqGb("10", "근접시초가조회");
            reqGb[4] = new ReqGb("11", "매수비율계산");
            reqGb[5] = new ReqGb("12", "자동추매풀조회");
            reqGb[6] = new ReqGb("13", "종목마스터최신화");
            reqGb[7] = new ReqGb("91", "가격지표");
            reqGb[8] = new ReqGb("20", "풀추적");            
            reqGb[9] = new ReqGb("99", "테스트");
            reqGb[10] = new ReqGb("92", "종목별투자자조회");
            reqGb[11] = new ReqGb("93", "종합주가지수조회");
        }
    }
