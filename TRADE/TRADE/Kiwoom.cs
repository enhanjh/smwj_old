...
namespace SMWJ
{
    ...
    public class KOACode
    {
        ...
        public readonly static ReqGb[] reqGb = new ReqGb[10];
        ...
        static KOACode()
        {
            ...
            reqGb[5] = new ReqGb("12", "계좌수익률조회");
            reqGb[6] = new ReqGb("13", "보유주식전량매도");
            reqGb[7] = new ReqGb("20", "풀추적");
            reqGb[8] = new ReqGb("91", "타이머종료");
